/* jQuery shake plugin -by Sujeet <sujeetkv90@gmail.com> */
	...
	$.fn.shake = function(options){
		...
		return this.each(function(i){
			...
			.animate(animation3, ((intDuration/intShakes)/4), function(){
				restore(el, i);
				if($.isFunction(settings.complete)) settings.complete(el);
			});
		});
	};
})(jQuery);
